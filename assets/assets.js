...
export const serviceData = [
  ...
  },
  {
    ...
    description:
      "Backend development ensures secure, efficient data handling and system functionality behind the scenes.",
    link: "",
  },
  {
    ...
    description:
      "AI-powered applications leverage intelligent algorithms to deliver smart, adaptive user experiences.",
    link: "",
  },
];
...
export const infoList = [
  {
    ...
    description:
      "Python, Java, C++, Javascript, Node.js, React.js, Express.js, Rest API, MySQL, MongoDB",
  },
  {
